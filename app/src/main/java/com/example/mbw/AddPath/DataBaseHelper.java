...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME ="stationInfo.db";
    ...
    public ArrayList<AddSubItem> searchLine(String selectedLine) {
        ArrayList<AddSubItem> subItemList = new ArrayList<AddSubItem>();

        Cursor c = mDataBase.rawQuery("select * from stationInfo where line ='selectedLine';", null);
        while (c.moveToNext()) {
            String id = c.getString(0);
            String stationName = c.getString(1);
            String line = c.getString(2);
            subItemList.add(new AddSubItem(id, stationName, line));
        }
        return subItemList;
    }
